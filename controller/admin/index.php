...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
      ...
      <img src="/aap/asset/img/icon.png" alt="Logo" class="brand-image img-circle elevation-3"
                            ...
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">
                                    ...
                                    <?php
                                        ...
                                        case 'admin_add' : echo 'admin_add'; break;

                                        case 'admin_del' : echo 'admin_del'; break;
